...
|------|------|------|--------|--------|------|------|------|
| 1 | 002 | **xgboost_v2** | **55.59%** | -0.02 | 662 | ❌ 反轉 | 2026-02-15 |
| 2 | 001 | xgboost_v1 | 51.17% | -0.08 | 57457 | ⚠️ 停滯 | 2026-02-15 |
| 3 | 004 | lgbm_v1 | 50.25% | -0.11 | 591 | ❌ 反轉 | 2026-02-15 |

### 30m (Breakeven: 54.05%)

| 排名 | 實驗 | 策略 | OOS DA | Sharpe | 樣本 | 校準 | 日期 |
|------|------|------|--------|--------|------|------|------|
| 1 | 004 | **lgbm_v1** | **54.34%** | 0.01 | 530 | ❌ 反轉 | 2026-02-15 |
| 2 | 001 | xgboost_v1 | 51.24% | -0.05 | 25863 | ❌ 反轉 | 2026-02-15 |
| 3 | 002 | xgboost_v2 | 49.89% | -0.09 | 463 | ⚠️ 停滯 | 2026-02-15 |

### 60m (Breakeven: 54.05%)

| 排名 | 實驗 | 策略 | OOS DA | Sharpe | 樣本 | 校準 | 日期 |
|------|------|------|--------|--------|------|------|------|
| 1 | 004 | **lgbm_v1** | **54.46%** | 0.01 | 101 | ⚠️ 樣本少 | 2026-02-15 |
| 2 | 002 | xgboost_v2 | 51.72% | -0.05 | 203 | ⚠️ 停滯 | 2026-02-15 |
| 3 | 001 | xgboost_v1 | 50.78% | -0.06 | 13979 | ⚠️ 停滯 | 2026-02-15 |
...
| TF | OOS DA | Sharpe | Trades | PnL | MDD | Max Consec Loss | 校準 |
|----|--------|--------|--------|-----|-----|-----------------|------|
| 10m | **55.59%** | -0.02 | 662 | -73.29 | 303 | 7 | ❌ 反轉 |
| 30m | 49.89% | -0.09 | 463 | -251.57 | 251 | 11 | ⚠️ 停滯 |
| 60m | 51.72% | -0.05 | 203 | -60.77 | 69 | 8 | ⚠️ 停滯 |
| 1440m | 14.29% | -0.94 | 7 | -29.36 | 35 | 6 | ❌ 數據不足 |
...
| TF | OOS DA | Sharpe | Trades | PnL | MDD | Max Consec Loss | 校準 |
|----|--------|--------|--------|-----|-----|-----------------|------|
| 10m | 50.25% | -0.11 | 591 | -377.82 | 399 | 8 | ❌ 反轉 |
| 30m | **54.34%** | **0.01** | 530 | **+14.93** | 199 | 6 | ❌ 反轉 |
| 60m | **54.46%** | **0.01** | 101 | **+3.39** | 54 | 7 | ⚠️ 樣本少 |
| 1440m | 0.00% | 0.00 | 3 | -16.50 | 11 | 3 | ❌ 數據不足 |
