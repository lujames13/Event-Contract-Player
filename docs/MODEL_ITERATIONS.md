...
|------|------|------|--------|--------|------|------|------|
| 1 | 001 | xgboost_v1 | 50.8% | -0.11 | 3185 | ❌ 反轉 | 2026-02-14 |
...
|----|--------|--------|--------|-----|-----|-----------------|------|
| 10m | 50.8% | -0.11 | 3185 | -3114 | 3198 | 10 | ❌ 反轉 |
| 30m | — | — | — | — | — | — | 待跑 |
| 60m | — | — | — | — | — | — | 待跑 |
| 1440m | — | — | — | — | — | — | 待跑 |
...
| Confidence Bucket | 實際勝率 | 樣本數 | 判定 |
|-------------------|---------|--------|------|
| 0.6 - 0.7 | 52.96% | 1571 | — |
| 0.7 - 0.8 | 50.60% | 917 | ⚠️ 下降 |
| 0.8 - 0.9 | 49.01% | 506 | ⚠️ 下降 |
| 0.9 - 1.0 | 38.74% | 191 | ❌ 嚴重反轉 |
