...
| **1** | 模型實驗池成熟 | 🔄 **ACTIVE** | 見下方 Gate 1 細則 | XGBoost baseline DA 50.8%，遠低於 breakeven |
...
|------|------|----|--------|--------|------|------|------|
| 001 | xgboost_v1 | 10m | 50.8% | -0.11 | 3185 | ❌ 反轉 | 2026-02-14 |
| 001 | xgboost_v1 | 30m | — | — | — | — | 待跑 |
| 001 | xgboost_v1 | 60m | — | — | — | — | 待跑 |
| 001 | xgboost_v1 | 1440m | — | — | — | — | 待跑 |
